...
//		}
		...
		//安装权限 2018-05-16  08:16 Charles
		IInstaller installer  = SpringContextHolder.getBean("authInstaller");
		installer.install(productId, null); /*2018-05-16 08:17:31  Comphoner */
		...
		installer.install(productId, null);	 /*2018-05-16 08:17:16  Comphoner */
		end = this.logEnd("exampleDataInstaller, 完成", end);
		//系统设置安装
		installer = SpringContextHolder.getBean("systemSettingInstaller");
		installer.install(productId, null);	 /*2018-05-16 08:17:19  Comphoner */
	...
	private void install(String type, Document proFileDoc, String productId) {
		...
		if (nodeList != null) {
			...
			installer.install(productId, nodeList.item(0));  /*2018-05-16 08:18:04  Comphoner */
		}
	}
