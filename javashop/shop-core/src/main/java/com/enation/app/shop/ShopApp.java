...
public class ShopApp extends App {
	...
	/**
	 * 系统初始化安装时安装base的sql脚本 2018-05-16  08:05 Charles
	 */
	public void install() {
		/**
		 * 安装网店数据库表结构
		 */
		this.doInstall("file:com/enation/app/shop/shop.xml"); /*2018-05-16 08:01:53  Comphoner */
		
		/**
		 * 安装网店数据库索引
		 */
		this.doInstall("file:com/enation/app/shop/shop_index.xml");  /*2018-05-16 08:02:06  Comphoner */
	}
